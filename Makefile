...
ACLOCAL = ${SHELL} /home/gnocuil/git/thudhcp-server/missing --run aclocal-1.10
AMTAR = ${SHELL} /home/gnocuil/git/thudhcp-server/missing --run tar
ATF_CFLAGS = 
ATF_LDFLAGS = 
AUTOCONF = ${SHELL} /home/gnocuil/git/thudhcp-server/missing --run autoconf
AUTOHEADER = ${SHELL} /home/gnocuil/git/thudhcp-server/missing --run autoheader
AUTOMAKE = ${SHELL} /home/gnocuil/git/thudhcp-server/missing --run automake-1.10
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/gnocuil/git/thudhcp-server/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = dhcp
...
STRIP = 
VERSION = 4.2.5-P1
abs_builddir = /home/gnocuil/git/thudhcp-server
abs_srcdir = /home/gnocuil/git/thudhcp-server
abs_top_builddir = /home/gnocuil/git/thudhcp-server
abs_top_srcdir = /home/gnocuil/git/thudhcp-server
ac_ct_CC = gcc
ac_prefix_program = 
am__include = include
am__leading_dot = .
...
install_sh = $(SHELL) /home/gnocuil/git/thudhcp-server/install-sh
